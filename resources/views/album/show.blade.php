...
@section('content')
    ...
    @if(Session::has('album_edited'))
        <div class="alert alert-success">
            <p>{{Session::get('album_edited')}}</p>
        </div>
    @endif
                    ...
                    <div class="col-sm-6 col-md-4">
                        <div class="thumbnail">
                            <div class="caption">
                                ...
                                <p><a href="/validated/albums/edit-album/?id={{$album->id}}" class="btn btn-primary" role="button">Edit Album</a></p>
